...
def lambda_handler(data, _context):
    ...
    actions_taken = "The EKS pod has been terminated and stake-holders have been informed." if data[
    ...
    body = f'''\
{severity} EKS-related INCIDENT in account "{account_name}" ({account_id}, OU: {organizational_unit}), region {resource_region}:
