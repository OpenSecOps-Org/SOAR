...
- **OpenSSF Scorecard** — automated supply-chain posture analysis covering ~18 dimensions (branch protection, signed releases, pinned dependencies, dangerous workflow patterns, etc.). Score and per-check findings published at https://scorecard.dev/viewer/?uri=github.com/OpenSecOps-Org/SOAR.
