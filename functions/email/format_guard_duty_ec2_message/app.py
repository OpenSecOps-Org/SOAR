...
def lambda_handler(data, _context):
    ...
    actions_taken = "The instance has been terminated and stake-holders have been informed." if data[
        'incident']['terminate'] else 'None.'
    ...
    body = f'''\
{severity} EC2-related INCIDENT in account "{account_name}" ({account_id}, OU: {organizational_unit}), region {resource_region}:
