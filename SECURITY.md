...
Together they are the authoritative cross-component references; the per-component sections above describe how the project-wide posture applies to **SOAR** specifically.
